...
Write-Host "Database Migrations for auth-service" -ForegroundColor Cyan

if (!(Test-Path "package.json")) {
    Write-Host "Error: package.json not found. Make sure you are in auth-service directory" -ForegroundColor Red
    exit 1
}
